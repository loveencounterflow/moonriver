(function() {
  ...
  get_types = function() {
    ...
    types.declare.mr_async_nonsource_fitting(function(x) {
      if (!this.isa.function12.or.asyncfunction12(x)) {
        return false;
      }
      return true;
    });
    ...
    types.declare.function12({
      isa: function(x) {
        var ref;
        return (this.isa.function(x)) && ((0 < (ref = x.length) && ref < 3));
      },
      default: function(x, y) {},
      override: true
    });
    ...
    types.declare.asyncfunction12({
      isa: function(x) {
        var ref;
        return (this.isa.asyncfunction(x)) && ((0 < (ref = x.length) && ref < 3));
      },
      default: function(x, y) {},
      override: true
    });
