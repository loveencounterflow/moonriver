(function() {
  ...
  get_types = function() {
    ...
    types.declare.mr_sync_repeatable_source_fitting({
      isa: 'function0',
      override: true
    });
    types.declare.mr_sync_observer_fitting({
      isa: 'function1',
      override: true
    });
    types.declare.mr_sync_transducer_fitting({
      isa: 'function2',
      override: true
    });
    //---------------------------------------------------------------------------------------------------------
    ...
    types.declare.mr_async_repeatable_source_fitting({
      isa: 'function0.or.asyncfunction0',
      override: true
    });
    types.declare.mr_async_observer_fitting({
      isa: 'function1.or.asyncfunction1',
      override: true
    });
    types.declare.mr_async_transducer_fitting({
