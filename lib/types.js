(function() {
  'use strict';
  var GUY, Intertype, STREAM, alert, async_types, base_types, debug, echo, get_async_source_fitting_types, get_async_types, get_base_types, get_sync_source_fitting_types, get_sync_types, help, info, inspect, log, misfit, plain, praise, rpr, snyc_types, stf_prefix, urge, warn, whisper;
  ...
  stf_prefix = '_transform_from_fitting';
