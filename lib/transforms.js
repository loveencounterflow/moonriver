(function() {
  ...
  this.$named_window = function(cfg) {
    var Pipeline, R, empty, i, idx, map, max, min, names, ref, ref1;
    ...
    max = -min;
    map = {};
    for (idx = i = ref = min, ref1 = max; (ref <= ref1 ? i <= ref1 : i >= ref1); idx = ref <= ref1 ? ++i : --i) {
      map[idx + min + 1] = names[idx + max];
    }
    debug('^89384563^', map);
    //.........................................................................................................
    R.push(this.$window({min, max, empty}));
    R.push(function(d, send) {
      var e, name;
      debug('^647698^', d);
      e = {};
      for (idx in map) {
