(function() {
  'use strict';
  var $, Async_pipeline, Async_segment, GUY, Pipeline, Proto_segment, Reporting_collector, Segment, UTIL, alert, debug, def, echo, entries, get_async_types, get_base_types, get_sync_types, help, hide, info, inspect, log, misfit, nameit, noop, plain, praise, rpr, stf, stf_prefix, transforms, urge, warn, whisper;
  ...
  ({misfit, stf_prefix, get_base_types, get_sync_types, get_async_types} = require('./types'));
  ...
  Segment = (function() {
    ...
    class Segment {
      ...
      [stf`sync_pipeline`](φ) {
        var transform;
        transform = nameit('pipeline', function(d, send) {
          var e, i, len, ref;
          φ.send(d);
          ref = φ.run();
  ...
  //###########################################################################################################
  module.exports = {Pipeline, Segment, Async_pipeline, Async_segment, Reporting_collector, transforms, Proto_segment, $, get_base_types, get_sync_types, get_async_types};
