(function() {
        ...
        case 'function':
          switch ((arity = raw_transform.length)) {
            case 1:
              ...
              break;
            case 2:
              if (modifiers.once_after_last === true) {
  ...
  Moonriver = class Moonriver {
    ...
    * [Symbol.iterator]() {
    ...
    _drive(cfg) {
      /* TAINT validate `cfg` */
      var collection, defaults, do_exit, first_idx, i, idx, j, l, last_idx, len, len1, ref, ref1, ref2, segment;
      defaults = {
        mode: 'breadth',
        continue: false,
        first_idx: 0,
      ...
      if (!cfg.continue) {
        ref = [this.segments, this.on_once_after_last];
        for (i = 0, len = ref.length; i < len; i++) {
          collection = ref[i];
...
*/
//.......................................................................................................
        for (idx = l = ref1 = first_idx, ref2 = last_idx; (ref1 <= ref2 ? l <= ref2 : l >= ref2); idx = ref1 <= ref2 ? ++l : --l) {
