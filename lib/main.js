(function() {
  'use strict';
  var $, Async_pipeline, Async_segment, GUY, Pipeline, Proto_segment, Reporting_collector, Segment, UTIL, alert, debug, def, echo, get_async_types, get_sync_types, help, hide, info, inspect, log, misfit, nameit, noop, plain, praise, rpr, stf, stf_prefix, transforms, urge, warn, whisper;
  ...
  Segment = (function() {
    ...
    class Segment {
      ...
      _set_transform(fitting) {
        var fitting_type, name, sigil, transform, transform_type;
        sigil = null;
        //.......................................................................................................
        switch (fitting_type = this.types.type_of(fitting)) {
          ...
          case 'producer_fitting':
            this._on_before_walk = function() {
              var source;
              source = fitting();
              this.transform = (this._get_source_transform(this.types.type_of(source), source)).transform;
          ...
          case 'transducer_fitting':
            ...
            transform = fitting; // 'source_fitting'
            break;
          default:
            //.....................................................................................................
            ({transform_type, transform} = this._get_source_transform(fitting_type, fitting));
        }
        //.......................................................................................................
      ...
      [stf`list`](source) {
        var transform;
        ({transform} = this[stf`generator`](source.values()));
      ...
      [stf`object`](source) {
        var transform;
        ({transform} = this[stf`generator`]((function*() {
          var k, results, v;
          results = [];
          for (k in source) {
            v = source[k];
      ...
      [stf`map`](source) {
        var transform;
        ({transform} = this[stf`generator`](source.entries()));
