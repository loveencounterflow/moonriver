(function() {
  'use strict';
  var Async_pipeline, Async_segment, GUY, Pipeline, Reporting_collector, Segment, UTIL, alert, debug, def, echo, get_async_types, get_sync_types, help, hide, info, inspect, log, nameit, noop, plain, praise, rpr, stf, stf_prefix, transforms, types, urge, warn, whisper;
  ...
  ({stf_prefix, get_sync_types, get_async_types} = require('./types'));
  ...
  Segment = (function() {
    ...
    class Segment {
      ...
      constructor(cfg) {
        ...
        this.types.create[clasz.my_type](cfg);
      ...
      _as_transform(fitting) {
        ...
        clasz = this.constructor;
        sigil = null;
        debug('^4345^', this.types.type_of(fitting));
        // debug '^4345^', {
        //   name:        fitting.name,
    ...
    Segment.my_type = 'sync_segment_cfg';

    Segment.fitting_type = 'sync_fitting';

    Segment.source_fitting_type = 'sync_source_fitting';

    Segment.repeatable_source_fitting_type = 'sync_repeatable_source_fitting';

    Segment.observer_fitting_type = 'sync_observer_fitting';

    Segment.transducer_fitting_type = 'sync_transducer_fitting';

    Segment.duct_fitting_type = 'sync_duct_fitting';
  ...
  Async_segment = (function() {
    ...
    Async_segment.my_type = 'segment_cfg';

    Async_segment.fitting_type = 'fitting';

    Async_segment.source_fitting_type = 'source_fitting';

    Async_segment.repeatable_source_fitting_type = 'repeatable_source_fitting';

    Async_segment.observer_fitting_type = 'observer_fitting';

    Async_segment.transducer_fitting_type = 'transducer_fitting';

    Async_segment.duct_fitting_type = 'duct_fitting';
