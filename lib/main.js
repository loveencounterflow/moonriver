      ...
      constructor(raw_pipeline) {
        ...
        for (idx = i = 0, len = raw_pipeline.length; i < len; idx = ++i) {
          ...
          ((is_sender, is_source, modifications, transform, idx) => {
            ...
            //...................................................................................................
            if (is_sender) {
              if (modifications.once_after !== symbol.misfit) {
              ...
              call = function(d) {
                ...
                this.transform(d);
                if (!((this.modifications.once_before !== symbol.misfit) || (this.modifications.once_after !== symbol.misfit))) {
                  this.send(d);
                }
                return null;
              };
            ...
            if (modifications.once_before !== symbol.misfit) {
