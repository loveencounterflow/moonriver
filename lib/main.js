(function() {
  'use strict';
  var Async_pipeline, Async_segment, GUY, Pipeline, Reporting_collector, Segment, UTIL, alert, debug, def, echo, get_types, help, hide, info, inspect, log, nameit, plain, praise, rpr, stf, stf_prefix, types, urge, warn, whisper;
