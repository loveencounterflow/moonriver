(function() {
  'use strict';
  var CND, Duct, GUY, Modified_transform, Moonriver, Segment, UTIL, add_length_prop, badge, debug, echo, help, info, isa, pluck, rpr, symbol, type_of, types, urge, validate, warn, whisper,
    splice = [].splice;
    ...
    _transform_from_raw_transform(raw_transform) {
      ...
      if (this.is_sender) {
        if (this.modifiers.once_before_first || this.modifiers.once_after_last) {
          ...
          this.call = (d) => {
            this.call_count++;
            if ((this.call_count === 1) && this.modifiers.do_first) {
          ...
          switch ((arity = raw_transform.length)) {
            ...
            case 2:
              if (modifiers.once_before_first || modifiers.once_after_last) {
                throw new Error("^moonriver@2^ transform with arity 2 not implemented for modifiers " + "once_before_first, once_after_last");
              }
              transform = raw_transform;
              break;
            default:
  ...
  Modified_transform = (function() {
    ...
    class Modified_transform {
      ...
      constructor(...modifiers) {
        var defaults, key, ref, transform;
  ...
  Moonriver = class Moonriver {
    ...
    * [Symbol.iterator]() {
    ...
    //---------------------------------------------------------------------------------------------------------
    drive(cfg) {
      var R, collection, i, j, l, len, len1, len2, len3, m, ref, ref1, ref2, segment;
    ...
    _drive(cfg) {
      /* TAINT validate `cfg` */
      var defaults, do_exit, first_idx, i, idx, last_idx, ref, ref1, segment;
      defaults = {
        mode: 'breadth',
        first_idx: 0,
        last_idx: -1
