(function() {
  'use strict';
  var Async_pipeline, Async_segment, GUY, Pipeline, Reporting_collector, Segment, UTIL, alert, debug, def, echo, get_async_types, get_sync_types, help, hide, info, inspect, log, misfit, nameit, noop, plain, praise, rpr, stf, stf_prefix, transforms, types, urge, warn, whisper;
