(function() {
  'use strict';
  var CND, GUY, Modifications, badge, debug, echo, help, info, isa, misfit, rpr, symbol, type_of, types, urge, validate, warn, whisper,
    splice = [].splice;
          ...
          ((is_sender, is_source, modifications, transform, idx) => {
            ...
            if (is_sender) {
              call = function(d) {
                ...
                if ((this.send.call_count === 1) && ((first = this.modifications.first) !== misfit)) {
