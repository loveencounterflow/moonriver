(function() {
  'use strict';
  var Async_pipeline, Async_segment, GUY, Pipeline, Reporting_collector, Segment, UTIL, alert, debug, def, echo, get_types, help, hide, info, inspect, log, nameit, plain, praise, rpr, stf, stf_prefix, transforms, types, urge, warn, whisper;
  ...
  Segment = (function() {
    ...
    class Segment {
      ...
      _as_transform(fitting) {
        ...
        * `transform`: one of the serial elements that constitute a pipeline. While a `fitting` may be of
         ...
         */
        //.......................................................................................................
        if (this.types.isa.function0(fitting)) {
          this._on_before_walk = function() {
          ...
          R = fitting;
        //.......................................................................................................
        } else if (this.types.isa[this.constructor.fittying_type](fitting)) {
          R = this._get_source_transform(fitting);
          this.transform_type = 'source';
        } else {
          /* TAINT use types `function1` &c instead of `length` */
          //.......................................................................................................
          R = fitting;
    ...
    Segment.fittying_type = 'mr_sync_source_fitting';
  ...
  Async_segment = (function() {
    ...
    Async_segment.fittying_type = 'mr_async_source_fitting';
