(function() {
  ...
  Pipeline = (function() {
    ...
    class Pipeline {
      ...
      _protocol(j = null) {
        ...
        if (j != null) {
          d[`${j.segment.idx} ${j.segment.transform.name}`] = rpr(j.d);
        }
        d.o = this._last_output !== misfit ? this._last_output : rpr(this.output);
        this.journal.push(d);
        return null;
      }
      ...
      * _walk() {
      ...
      static * walk_named_pipelines(named_pipelines) {
        var _, i, idx, k, l, len, len1, names, pipeline, pipelines, process, type, types, v;
  ...
  Async_pipeline = (function() {
    ...
    class Async_pipeline extends Pipeline {
      ...
      async * walk() {
        var d, i, l, len, len1, ref, ref1, segment;
        if (this.segments.length === 0) {
          this.push(nameit('(dummy)', function(d) {}));
        }
        ref = this.segments;
