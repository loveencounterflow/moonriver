  ...
  Segment = (function() {
    ...
    class Segment {
      ...
      _as_transform(fitting) {
        var R, clasz, fitting_type, name, sigil;
        clasz = this.constructor;
        sigil = null;
        //.......................................................................................................
        switch (fitting_type = this.types.type_of(fitting)) {
          //.....................................................................................................
          case 'producer_fitting':
            this._on_before_walk = function() {
              var source;
              source = fitting();
              this.transform = this._get_source_transform(this.types.type_of(source), source);
              return null;
            };
            ...
            break;
          //.....................................................................................................
          case 'observer_fitting':
            R = fitting;
            this.transform_type = 'observer';
            sigil = '?o';
            break;
          //.....................................................................................................
          case 'transducer_fitting':
            R = fitting;
            this.transform_type = 'transducer';
            sigil = '?t'; // 'source_fitting'
            break;
          default:
            //.....................................................................................................
            R = this._get_source_transform(fitting_type, fitting);
            this.transform_type = 'source';
            sigil = '?sn ';
        }
        //.......................................................................................................
      ...
      [stf`generatorfunction`](source) {
        return this._get_source_transform('generator', source());
      }
  ...
  Pipeline = (function() {
    ...
    class Pipeline {
      ...
      constructor(cfg) {
        ...
        hide(this, '$', nameit('$', this._segment_from_transform.bind(this)));
        hide(this, 'types', clasz.type_getter());
        def(this, 'sources', {
          get: function() {
            var s;
      ...
      _segment_from_transform(modifiers, fitting) {
        ...
        var R, arity, count, error, input, prv_segment;
      ...
      push(...P) {
        var R;
        this.segments.push(R = this._segment_from_transform(...P));
