(function() {
  ...
  Segment = class Segment {
    ...
    [stf_prefix + 'list'](source) {
      return nameit('Σlst', this[stf_prefix + 'generator'](source.values()));
    }

    [stf_prefix + 'object'](source) {
      return nameit('Σobj', this[stf_prefix + 'generator']((function*() {
        var k, results, v;
        results = [];
        for (k in source) {
          v = source[k];
    ...
    [stf_prefix + 'set'](source) {
      return nameit('Σset', this[stf_prefix + 'generator'](source.values()));
    }

    [stf_prefix + 'map'](source) {
      return nameit('Σmap', this[stf_prefix + 'generator'](source.entries()));
    }
