(function() {
  ...
  Segment = class Segment {
    ...
    [stf_prefix + 'list'](source) {
      return nameit('√lst', this[stf_prefix + 'generator'](source.values()));
    }

    [stf_prefix + 'object'](source) {
      return nameit('√obj', this[stf_prefix + 'generator']((function*() {
        var k, results, v;
        results = [];
        for (k in source) {
          v = source[k];
    ...
    [stf_prefix + 'set'](source) {
      return nameit('√set', this[stf_prefix + 'generator'](source.values()));
    }

    [stf_prefix + 'map'](source) {
      return nameit('√map', this[stf_prefix + 'generator'](source.entries()));
    }
